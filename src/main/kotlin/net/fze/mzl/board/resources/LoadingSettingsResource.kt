...
import net.fze.mzl.board.service.LoadingSettingsService
...
/* ¼ÓÔØÒ³ÉèÖÃ±í资源 */
@Path("/loading_settings")
@Produces(MediaType.APPLICATION_JSON)
@Consumes(MediaType.APPLICATION_JSON)
class LoadingSettingsResource {
    @Inject
    private lateinit var service:LoadingSettingsService

    @GET
    @Path("/{id}")
    fun get(@PathParam("id") id:Int): LoadingSettingsEntity? {
        return service.findByIdOrNull(id)
    }

    @GET
    fun list(): Set<LoadingSettingsEntity> {
        return mutableSetOf()
    }

    @POST
    fun save(entity: LoadingSettingsEntity):Result {
        val err = this.service.saveLoadingSettings(entity)
